...
class App extends Component {
  ...
  handleNewConnectAccept () {
    const oldOtherSocketId = this.state.otherSocketId
    const newOtherSocketId = this.state.showToastNewConnectionSocketId
    const newOtherPublicKey = this.state.showToastNewConnectionPublicKey
    this.setState({
      showToastNewConnection: false,
      showToastNewConnectionPublicKey: -1,
      showToastNewConnectionSocketId: -1,
  ...
  handleNewConnectReject () {
    const showToastNewConnectionSocketId = this.state.showToastNewConnectionSocketId
    this.setState({
      showToastNewConnection: false,
      showToastNewConnectionPublicKey: -1,
      showToastNewConnectionSocketId: -1

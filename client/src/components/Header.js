          ...
          <Navbar.Collapse id='basic-navbar-nav'>
            <Nav className='mr-auto'>
              ...
              {this.state.connected
                ? <Button style={{ marginLeft: '1em' }} variant='success' onClick={() => this.props.handleConnectTerminate()}>Connected</Button>
                : <Button style={{ marginLeft: '1em' }} variant='danger'>Not Connected</Button>}
            </Nav>
            <span style={{ lineHeight: '1em', float: 'right' }}>
              {this.state.socketId !== -1
                ? (<Alert style={{ padding: '0.2em', margin: '0px', float: 'right' }} variant='danger' onClick={() => this.copyToClipboard()}>
